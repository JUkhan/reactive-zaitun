...
var Router = /** @class */ (function () {
    ...
    Router.prototype.setEffect = function () {
    ...
    Router.prototype.initRoutes = function () {
        ...
        this.history = this.options.locationStrategy === 'hash' ?
            history_1.createHashHistory(this.options.hashOrHistoryOrMemoryOptions) :
            this.options.locationStrategy === 'history' ?
                history_1.createBrowserHistory(this.options.hashOrHistoryOrMemoryOptions) :
                history_1.createMemoryHistory(this.options.hashOrHistoryOrMemoryOptions);
        /*const unlisten =*/ this.history.listen(function (location, action) {
            _this.render(_this.getRoute(location), location);
        });
        captureClicks_1.captureClicks(function (location) {
            _this.destroy(_this.getRoute(location), location);
        });
        if (!this.clearSlashes(this.history.location.pathname)) {
            var loc = { pathname: this.options.activePath, search: '' };
    ...
    Router.prototype.renderMainComponent = function () {
        this.CM.router = this;
    ...
    Router.prototype.destroy = function (route, location) {
        var _this = this;
        ...
        this.CM.canActivate(route, function (isActive) {
            if (isActive) {
                _this.CM.destroy(location, function (cbLocation) {
                    _this.history.push(location.pathname + location.search);
                });
            }
        });
    };
    Router.prototype.render = function (route, location) {
        var _this = this;
    ...
    Router.prototype.getRouteParams = function (route, location) {
        ...
        if (location.search.startsWith('?')) {
            routeParams.search = location.search.substr(1)
                .split('&').reduce(function (a, n) {
                var d = n.split('=');
                a[d[0]] = isNaN(d[1]) ? d[1] : Number(d[1]);
                return a;
            }, {});
        }
        return routeParams;
    ...
    Router.prototype.addEffect = function (effectCallback) {
        if (this.effect$) {
    ...
    Router.prototype.navigate = function (path) {
        var location = { pathname: path, search: '' };
    ...
    Router.prototype.bindEffect = function (dispatch) {
        ...
        return function (action, brodcast) {
            ...
            _dispatch(action);
            if (_this.effectManager && brodcast) {
